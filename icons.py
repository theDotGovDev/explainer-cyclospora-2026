...
SPRITE_SYMBOLS = {
    ...
    # broader food groups, for the top-100 list
    "grain": '<path d="M12 21V9"/><path d="M12 12c-2.4 0-4-1.7-4-4 2.4 0 4 1.7 4 4Z"/><path d="M12 12c2.4 0 4-1.7 4-4-2.4 0-4 1.7-4 4Z"/><path d="M12 7c-2 0-3.4-1.4-3.4-3.2C10.6 3.8 12 5.2 12 7Z"/><path d="M12 7c2 0 3.4-1.4 3.4-3.2C13.4 3.8 12 5.2 12 7Z"/>',
    "bread": '<path d="M4 11c0-3 3.6-5 8-5s8 2 8 5c0 1.5-1.2 2-2 2v5.5a1 1 0 0 1-1 1H7a1 1 0 0 1-1-1V13c-.8 0-2-.5-2-2Z"/>',
    "dairy": '<path d="M9 3h6v2.8l2.2 3.4A2 2 0 0 1 17.5 12v7.5a1.5 1.5 0 0 1-1.5 1.5H8a1.5 1.5 0 0 1-1.5-1.5V12a2 2 0 0 1 .3-2.8L9 5.8Z"/>',
    "meat": '<path d="M15.5 4.5c3 0 5 2.2 5 5 0 3.4-2.8 5.4-5.4 6.6-2.2 1-3 1.4-4.2 2.8A4 4 0 0 1 4.2 13a4 4 0 0 1 5.4-3.7c1.4-1.2 1.8-2 2.8-3.2 1-1.1 2-1.6 3.1-1.6Z"/><circle cx="8" cy="16" r="2"/>',
    "fish": '<path d="M3 12c3-4 7-6 10.5-6 3.5 0 6 2.2 7.5 6-1.5 3.8-4 6-7.5 6C9.5 18 6 16 3 12Z"/><path d="m21 12 .0 0"/><circle cx="16.5" cy="10.5" r="1"/><path d="M3 12c1.5-1 2.5-1.4 3.5-1.5M3 12c1.5 1 2.5 1.4 3.5 1.5"/>',
    "egg": '<path d="M12 3c3.6 0 6.5 5 6.5 9.2A6.5 6.5 0 0 1 5.5 12.2C5.5 8 8.4 3 12 3Z"/>',
    "drink": '<path d="M6 4h12l-1.4 15.2a2 2 0 0 1-2 1.8H9.4a2 2 0 0 1-2-1.8Z"/><path d="M6.7 10h10.6"/>',
    "nut": '<path d="M12 3c4 0 7 3.6 7 8.4S15.6 21 12 21s-7-4.4-7-9.6S8 3 12 3Z"/><path d="M12 3.5v17M8 8c1.6 1.4 1.6 6.6 0 8M16 8c-1.6 1.4-1.6 6.6 0 8"/>',
    "sweet": '<circle cx="12" cy="13" r="6"/><path d="M12 7V4"/><path d="M9.5 10.5c.8-.8 2-1.2 3-1"/>',
    "snack": '<path d="M4.5 9h15l-1.6 10.2a1 1 0 0 1-1 .8H7.1a1 1 0 0 1-1-.8Z"/><path d="M7 9V6.5A2.5 2.5 0 0 1 9.5 4h5A2.5 2.5 0 0 1 17 6.5V9"/>',
    "rice": '<path d="M4.5 12h15a7.5 7.5 0 0 1-7.5 7.5A7.5 7.5 0 0 1 4.5 12Z"/><path d="M8 8.5c.5-.8 1.4-1.2 2.2-1M12 7c.5-.8 1.4-1.2 2.2-1M9.6 5.2c.5-.8 1.4-1.2 2.2-1"/>',
    "root": '<path d="M12 21c-3.5-3-5.5-6-5.5-9.5A5.5 5.5 0 0 1 12 6a5.5 5.5 0 0 1 5.5 5.5C17.5 15 15.5 18 12 21Z"/><path d="M12 6V3"/><path d="M12 4c1.4-1.2 3-1.4 4-.9-.2 1.4-1.4 2.6-4 2.6"/>',
    # UI icons
